...
# run_services.sh - Run profile and search Go services with environment variables
# Usage: ./run_services.sh
# Runs both Go services in the background with timestamped log files
...
echo "=========================================="
echo "Go Services Configuration"
echo "=========================================="
echo ""
...
echo "Starting Go services in the background..."
echo ""
...
echo "=========================================="
echo "Go services running in background"
echo "=========================================="
